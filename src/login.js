...
function Login() {
    ...
    return (
        <>
        <Header />
            <div className="bg-primary-600 flex flex-col items-center justify-start px-6 py-8 mx-auto md:h-screen lg:py-0"> 
                <LogIn/>
            </div>
        </>
    );
        ...
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            ...
            <p className='text-center text-red-600'>{error}</p>
                ...
                <div className="flex items-center justify-between">
                      <div className="flex items-start">
                          <div className="flex items-center h-5">
                            <input id="remember" aria-describedby="remember" value={rememberMe} onChange={e => setRememberMe(e.target.checked)} type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300" required=""/>
                          </div>
                ...
                <div className="block text-center">
                    ...
                    <p className="text-center block text-sm font-medium text-black mt-1 mb-2"> or </p> 
                </div>
